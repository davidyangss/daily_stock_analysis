...
WEB_SETTINGS_HIDDEN_FROM_UI = {
    ...
    "PROXY_HOST",
    "PROXY_PORT",
    # Runtime retry policy is shared by all provider consumers and is kept in
    # deployment configuration rather than the end-user settings surface.
    "DATA_PROVIDER_MAX_ATTEMPTS",
    "DATA_PROVIDER_RETRY_BASE_DELAY_SECONDS",
    "DATA_PROVIDER_RETRY_MAX_DELAY_SECONDS",
    ...
    "TRADER_ANALYSIS_BROWSER_READER_ENABLED",
    "TRADER_ANALYSIS_BROWSER_READER_COMMAND",
    "TRADER_ANALYSIS_BROWSER_READER_MAX_PAGES",
    "TRADER_ANALYSIS_BROWSER_READER_TIMEOUT_SECONDS",
    "TRADER_ANALYSIS_BROWSER_READER_MAX_CHARS",
...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "PROVIDER_LOOP_TIMEOUT_SECONDS": {
        "title": "Provider Call Timeout",
        "description": "Maximum seconds allowed for one provider attempt before continuing to the next configured source.",
        "category": "data_source",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "validation": {"min": 0.1},
        "display_order": 21,
        "help_key": "settings.data_source.PROVIDER_LOOP_TIMEOUT_SECONDS",
        "examples": ["PROVIDER_LOOP_TIMEOUT_SECONDS=60"],
        "docs": [{
            "label": "数据源优先级与超时配置",
            "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/data-source-priority.md#provider-循环语义",
        }],
    },
    "PROVIDER_LOOP_TOTAL_TIMEOUT_SECONDS": {
        "title": "Provider Loop Total Timeout",
        "description": "Maximum total seconds for all configured provider attempts of one data capability.",
        "category": "data_source",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "validation": {"min": 0.1},
        "display_order": 22,
        "help_key": "settings.data_source.PROVIDER_LOOP_TOTAL_TIMEOUT_SECONDS",
        "examples": ["PROVIDER_LOOP_TOTAL_TIMEOUT_SECONDS=600"],
        "docs": [{
            "label": "数据源优先级与超时配置",
            "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/data-source-priority.md#provider-循环语义",
        }],
    ...
    "STOCK_OPTIONAL_PROVIDER_TIMEOUT_SECONDS": {
        "title": "Stock Optional Provider Timeout",
        "description": "Per-provider timeout for optional evidence in ordinary API stock analysis.",
        "category": "data_source",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 23,
        "help_key": "settings.data_source.PROVIDER_LOOP_TIMEOUT_SECONDS",
        "examples": ["STOCK_OPTIONAL_PROVIDER_TIMEOUT_SECONDS=10"],
        "docs": [{
            "label": "数据源优先级与超时配置",
            "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/data-source-priority.md#普通个股可选数据预算",
        }],
    },
    "STOCK_OPTIONAL_EVIDENCE_TIMEOUT_SECONDS": {
        "title": "Stock Optional Evidence Deadline",
        "description": "Overall wait deadline for optional evidence in ordinary API stock analysis.",
        "category": "data_source",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 24,
        "help_key": "settings.data_source.PROVIDER_LOOP_TOTAL_TIMEOUT_SECONDS",
        "examples": ["STOCK_OPTIONAL_EVIDENCE_TIMEOUT_SECONDS=90"],
        "docs": [{
            "label": "数据源优先级与超时配置",
            "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/data-source-priority.md#普通个股可选数据预算",
        }],
    ...
    "PROVIDER_TIMEOUT_OVERRIDES": {
        ...
        "description": "Comma-separated provider-specific timeouts in provider=seconds format.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 23,
        "help_key": "settings.data_source.PROVIDER_TIMEOUT_OVERRIDES",
        "examples": ["PROVIDER_TIMEOUT_OVERRIDES=iwencai=60,tushare=60,akshare_em=90"],
        "docs": [{
            "label": "数据源优先级与超时配置",
            "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/data-source-priority.md#provider-循环语义",
        }],
    ...
    "SERPAPI_TIMEOUT_SECONDS": {
        "title": "SerpAPI Timeout",
        "description": "SerpAPI primary search request timeout in seconds.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 41,
        "help_key": "settings.data_source.search_api_keys",
        "examples": ["SERPAPI_TIMEOUT_SECONDS=20"],
        "docs": [
            {
                "label": "完整指南：搜索服务配置",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#搜索服务配置",
    ...
    "SERPAPI_HARD_DEADLINE_SECONDS": {
        "title": "SerpAPI Hard Deadline",
        "description": "Hard worker wait deadline when the SerpAPI SDK stalls, independent of its socket timeout.",
        "category": "data_source",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 42,
        "help_key": "settings.data_source.search_api_keys",
        "examples": ["SERPAPI_HARD_DEADLINE_SECONDS=20"],
        "docs": [{
            "label": "完整指南：搜索服务配置",
            "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#搜索服务配置",
        }],
    ...
    "DAILY_MARKET_CONTEXT_TIMEOUT_SECONDS": {
        "title": "Daily Market Context Deadline",
        "description": "Overall deadline for live daily-market-context generation before stock analysis degrades and continues.",
        "category": "system",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 48,
        "help_key": "settings.system.market_review",
        "examples": ["DAILY_MARKET_CONTEXT_TIMEOUT_SECONDS=120"],
        "docs": [{
            "label": "完整指南：大盘上下文配置",
            "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#大盘上下文配置",
        }],
        "warning_codes": [],
    },
    "MARKET_CONTEXT_PROVIDER_TIMEOUT_SECONDS": {
        "title": "Market Context Provider Timeout",
        "description": "Per-provider budget inside daily market context generation.",
        "category": "system",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 49,
        "help_key": "settings.system.market_review",
        "examples": ["MARKET_CONTEXT_PROVIDER_TIMEOUT_SECONDS=10"],
        "docs": [{
            "label": "完整指南：大盘上下文配置",
            "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#大盘上下文配置",
        }],
    ...
    "MARKET_CONTEXT_STAGE_TIMEOUT_SECONDS": {
        "title": "Market Context Stage Timeout",
        "description": "Per-stage budget inside daily market context generation.",
        "category": "system",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 50,
        "help_key": "settings.system.market_review",
        "examples": ["MARKET_CONTEXT_STAGE_TIMEOUT_SECONDS=12"],
        "docs": [{
            "label": "完整指南：大盘上下文配置",
            "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#大盘上下文配置",
        }],
    ...
    "MARKET_CONTEXT_OVERVIEW_TIMEOUT_SECONDS": {
        "title": "Market Context Overview Timeout",
        "description": "Overall market-overview data budget inside daily market context generation.",
        "category": "system",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 51,
        "help_key": "settings.system.market_review",
        "examples": ["MARKET_CONTEXT_OVERVIEW_TIMEOUT_SECONDS=48"],
        "docs": [{
            "label": "完整指南：大盘上下文配置",
            "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#大盘上下文配置",
        }],
    ...
    "AGENT_SKILL_AGENT_TIMEOUT_S": {
        "title": "Strategy Specialist Timeout",
        "description": "Independent timeout cap in seconds for each ordinary strategy Specialist. The effective cap is the smaller of this value and the remaining orchestrator budget. Set to 0 to disable the independent cap.",
        "category": "agent",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 63,
        "help_key": "settings.agent.AGENT_RUNTIME_TIMEOUTS",
        "examples": [
            "AGENT_SKILL_AGENT_TIMEOUT_S=120",
            "AGENT_SKILL_AGENT_TIMEOUT_S=0",
        ],
        "docs": [
            {
                "label": "多策略执行契约",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/multi-strategy-contract.md",
            },
        ],
        "warning_codes": [],
    },
    "AGENT_STOCK_INFO_TIMEOUT_SECONDS": {
        "title": "Agent Stock Info Timeout",
        "description": "Overall caller budget in seconds for ordinary Agent get_stock_info. It does not change Trader Analysis timeouts or the shared provider defaults.",
        "category": "agent",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 64,
        "help_key": "settings.agent.AGENT_RUNTIME_TIMEOUTS",
        "examples": ["AGENT_STOCK_INFO_TIMEOUT_SECONDS=60"],
        "docs": [
            {
                "label": "多策略执行契约",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/multi-strategy-contract.md",
    ...
    "AGENT_STOCK_INFO_PROVIDER_TIMEOUT_SECONDS": {
        "title": "Agent Stock Info Provider Timeout",
        "description": "Per-provider slice in seconds reserved inside ordinary Agent get_stock_info for bounded valuation fallback, board membership, and name resolution.",
        "category": "agent",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 65,
        "help_key": "settings.agent.AGENT_RUNTIME_TIMEOUTS",
        "examples": ["AGENT_STOCK_INFO_PROVIDER_TIMEOUT_SECONDS=8"],
        "docs": [
            {
                "label": "多策略执行契约",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/multi-strategy-contract.md",
