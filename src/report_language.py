...
_REPORT_LABELS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "value_label": "数值",
        "meaning_label": "含义",
        "profit_ratio_label": "获利比例",
        "profit_ratio_meaning": "当前价格以下的获利筹码占比",
        "avg_cost_label": "平均成本",
        "avg_cost_meaning": "市场筹码的平均持仓成本",
        "chip_concentration_label": "90%筹码集中度",
        "chip_concentration_meaning": "90%筹码价格区间宽度占比，越低越集中",
        "chip_health_label": "筹码健康度",
        "chip_health_meaning": "结合获利比例与集中度得出的综合评价",
    ...
    "en": {
        ...
        "profit_ratio_label": "Profitable Chips",
        "profit_ratio_meaning": "Share of chips currently below the market price",
        "avg_cost_label": "Average Cost",
        "avg_cost_meaning": "Average holding cost represented by the chip distribution",
        "chip_concentration_label": "90% Chip Concentration",
        "chip_concentration_meaning": "Width of the 90% chip price range; lower means more concentrated",
        "chip_health_label": "Chip Health",
        "chip_health_meaning": "Overall assessment based on profitability and concentration",
    ...
    "ko": {
        ...
        "value_label": "값",
        "meaning_label": "의미",
        "profit_ratio_label": "수익 구간 비율",
        "profit_ratio_meaning": "현재가보다 낮은 가격에 형성된 매물대 비율",
        "avg_cost_label": "평균 비용",
        "avg_cost_meaning": "매물대 기준 평균 보유 비용",
        "chip_concentration_label": "90% 매물대 집중도",
        "chip_concentration_meaning": "90% 매물대 가격 구간 폭의 비율이며 낮을수록 집중됨",
        "chip_health_label": "매물대 건전성",
        "chip_health_meaning": "수익 비율과 집중도를 종합한 평가",
