...
export const ReportNews: React.FC<ReportNewsProps> = ({ recordId, limit = 8, language = 'zh' }) => {
  ...
  return (
    <Card variant="bordered" padding="none" className="home-panel-card !overflow-visible">
      <details data-testid="report-news" className="group">
        <summary className="sticky top-14 z-30 cursor-pointer list-none rounded-2xl bg-card/95 px-5 py-4 shadow-sm backdrop-blur group-open:rounded-b-none">
          <DashboardPanelHeader
            ...
            actions={(
              <div className="flex items-center gap-2">
                ...
                <span className="home-accent-chip hidden px-2 py-0.5 text-xs text-muted-text sm:inline-flex">
        ...
        <div className="home-divider border-t px-5 pb-5 pt-3">
